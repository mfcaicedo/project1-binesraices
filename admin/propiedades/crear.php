<?php
  header("Content-Type: text/html;charset=utf-8");
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if (!$imagen['name'] || $imagen['error']) {//php por default no permite subir imagenes de más de 2Mb
       ...
       if ($resultado) {
            ...
            header('Location: ../../admin?resultado=1');//llevo al usuario a otro lado hacia atrás y esto es importante para que el usuario no meta datos duplicados
...
<body>
    ...
    <main class="contenedor">
        ...
        <form action="" class="formulario" method="POST" action="admin/propiedades/crear.php" enctype="multipart/form-data"><!--enctyoe necesario para cargar las imagenes-->
